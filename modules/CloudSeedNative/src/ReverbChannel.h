...
//		ChannelLR channelLr;
	...
	public:
        ...
        ReverbChannel(int bufferSize, int samplerate, size_t channelIndex)
...
//			this->channelLr = leftOrRight;
        ...
        ReverbChannel(const ReverbChannel&) = delete;
        ReverbChannel operator=(const ReverbChannel&) = delete;
		...
		void SetParameter(Parameter para, double value)
		{
			...
			case Parameter::CrossSeed:
                ...
                crossSeed = (channelIndex == 0)? value:0;//channelLr == ChannelLR::Right ? value : 0;
