...
public:
    ...
    */
    StandaloneFilterWindow(const String& title,
        ...
        : DocumentWindow(title, juce::Colours::white, DocumentWindow::minimiseButton | DocumentWindow::closeButton)
...
class CloudseedStandaloneApp : public JUCEApplication {
public:
    CloudseedStandaloneApp()
    {
    ...
    virtual StandaloneFilterWindow* createWindow()
    {
        ...
        return new StandaloneFilterWindow(getApplicationName(),
            ...
            juce::Colour::fromFloatRGBA(.9, .9, .9, 1),
...
JUCE_CREATE_APPLICATION_DEFINE(CloudseedStandaloneApp)
